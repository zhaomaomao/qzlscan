...
public class OutRepositoryAdapter extends BaseAdapter {
    private LayoutInflater mInflater = null;
    private Context mContext;
    public List<RpositoryBillModel> repositoryBillModelList;

    public OutRepositoryAdapter(Context mContext, List<RpositoryBillModel> repositoryBillModelList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.item_out_repository_list, null);
        ...
        holder.tv_bill_no.setText("出库单号："+repositoryBillModelList.get(position).repositoryBillNo);//入库单号
        holder.tv_company_name.setText("销售单位："+repositoryBillModelList.get(position).relativeCompanyName);//供货单位
