...
public class OutRepositoryListActivity extends BaseAppCompatActivity implements View.OnClickListener {
    //头部公共区域
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_out_repository_list);
        initTitle();
        initView();
    }
    /**
    ...
    private void initTitle() {
        ...
        common_header_title.setText(getResources().getString(R.string.out_bill_list));
    ...
    private void initView() {
        ...
        for (int i = 0; i < mTitleList.size(); i++) {
            ContentFragment fragment = ContentFragment.newInstance(i, EnumQueryType.out_repository_bill.getVal());
