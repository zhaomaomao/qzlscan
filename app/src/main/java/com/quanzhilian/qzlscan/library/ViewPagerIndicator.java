...
public class ViewPagerIndicator extends HorizontalScrollView implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    private int unSelectTextColor = getResources().getColor(R.color.gray); //设置选中字体的颜色
    private int selectTextColor = getResources().getColor(R.color.in_scan_default); //设置未选中字体的颜色
    ...
    private void init() {
        ...
        mContext = getContext();
        diviceWidth = AppUtils.getDisplayWidth((Activity) mContext);
        // 设置属性
